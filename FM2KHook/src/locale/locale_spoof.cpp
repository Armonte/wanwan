...
// p_DialogBoxParamA moved to locale_spoof_dialog.cpp (external
// linkage, declared in locale_spoof_internal.h) -- that TU is its
// only caller; InstallLocaleSpoof below just binds it.
